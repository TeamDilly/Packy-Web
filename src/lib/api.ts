...
export interface DataResponseDtoUrlResponse {
  code: string
  message: string
  data: UrlResponse
}
...
export interface DataResponseDtoListSettingV2Response {
  code: string
  message: string
  data: SettingV2Response[]
}

export interface SettingV2Response {
  /** @example "패키 공식 SNS" */
  name: string
  /** @example "www.example.com" */
  url: string
...
export interface DataResponseDtoAppStatusResponse {
  code: string
  message: string
...
export interface DataResponseDtoYoutubeUrlValidationResponse {
  code: string
  message: string
  data: YoutubeUrlValidationResponse
}

export interface YoutubeUrlValidationResponse {
  status: boolean
}
...
export interface DataResponseDtoListNoticeResponse {
  code: string
  message: string
  data: NoticeResponse[]
}
...
export interface DataResponseDtoListString {
  code: string
  message: string
  data: string[]
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
     ...
     *
     * @tags 관리자 API
     * @name CreateBranchUrl
     * @summary branch 링크 생성
     * @request POST:/api/v1/admin/branch
     * @secure
     */
    createBranchUrl: (data: BranchRequest, params: RequestParams = {}) =>
      this.request<DataResponseDtoUrlResponse, any>({
     ...
     * @name GetSettingUrls
     * @summary 설정 링크 조회
     * @request GET:/api/v2/admin/settings
     * @secure
     */
    getSettingUrls: (params: RequestParams = {}) =>
      this.request<DataResponseDtoListSettingV2Response, any>({
    ...
    getStatus: (
      ...
      this.request<DataResponseDtoAppStatusResponse, any>({
    ...
    /**
     * @description 선물이 없을 경우 응답에서 gift 객체가 제외됩니다. <br>
     *
     * @tags 선물박스 관련 API
    ...
    getPresignedUrl: (fileName: string, params: RequestParams = {}) =>
      this.request<DataResponseDtoUrlResponse, void>({
    ...
    validateYoutubeUrl: (
      ...
      this.request<DataResponseDtoYoutubeUrlValidationResponse, void>({
     ...
     *
     * @tags 관리자 API
     * @name GetSettingUrls1
     * @summary 설정 링크 조회
     * @request GET:/api/v1/admin/settings
     * @secure
     */
    getSettingUrls1: (params: RequestParams = {}) =>
     ...
     * @secure
     */
    getNotices: (params: RequestParams = {}) =>
      this.request<DataResponseDtoListNoticeResponse, any>({
     ...
     * @name GetNotice
     * @summary 공지사항 단일 조회
     * @request GET:/api/v1/admin/notices/web/{noticeId}
     * @secure
     */
    getNotice: (noticeId: number, params: RequestParams = {}) =>
      this.request<DataResponseDtoListString, any>({
        path: `/api/v1/admin/notices/web/${noticeId}`,
        method: 'GET',
        secure: true,
        ...params,
      }),
